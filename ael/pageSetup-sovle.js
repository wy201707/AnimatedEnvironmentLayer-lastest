...
// define(["require", "exports", "esri/views/MapView", "esri/Map", "esri/geometry/Point", "esri/geometry/SpatialReference", "esri/Basemap", "dojo/on", "dojo/dom", "./animatedEnvironmentLayer"], function (require, exports, MapView, Map, Point, SpatialReference, Basemap, on, dom, animatedEnvironmentLayer_1) {
    define(["require", "exports", "esri/views/MapView", "esri/Map", "esri/geometry/Point", "esri/geometry/SpatialReference", "esri/Basemap", "dojo/on", "dojo/dom", "./ael-solve"], function (require, exports, MapView, Map, Point, SpatialReference, Basemap, on, dom, animatedEnvironmentLayer_1) {
        "use strict";
        ...
        var PageSetup = /** @class */ (function () {
            ...
            PageSetup.prototype.init = function () {
                ...
                this.mapView = new MapView({
                    container: "map-view",
                    center: new Point({ x: 118, y: 23.5, spatialReference: new SpatialReference({ wkid: 4326 }) }),
                    zoom: 7,
                    map: this.map,
                ...
                windLayerAny.on("point-report", function (rpt) {
                    ...
                    dom.byId("lon").innerHTML = rpt.lon ? rpt.lon.toFixed(2) : "n/a";
                    dom.byId("lat").innerHTML = rpt.lat ? rpt.lat.toFixed(2) : "n/a";
                });
